...
(function (html) {
    ...
    const tl = anime.timeline({
        ...
        .add({
            targets: ['.s-intro .text-pretitle', '.s-intro .text-huge-title', '.s-intro .text-nickname'],
            translateX: [100, 0],
            opacity: [0, 1],
    ...
    const ssPreloader = function () {
        ...
        window.addEventListener('load', function () {
            ...
            const typed = new Typed('.typing', {
                strings: ['Flutter Developer', 'Mobile Engineer', 'UI/UX Enthusiast', 'Team Player'],
                typeSpeed: 100,
                backSpeed: 50,
                loop: true
            });
